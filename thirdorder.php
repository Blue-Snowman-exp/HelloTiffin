...
<body>
    <section id="contact">
        ...
        <div id="contact-box">
            <form action="#" method="POST" name="form">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="num" id="num" placeholder="Enter number of days">
                </div>
        ...
        <?php
             ...
             session_start();
             if($con==true){
             $y="insert into info(Name,Email,Phone,Days,Message) values ('$Name','$Email',$Phone,$Days,'$Message')";   
        ...
        <?php
               echo" 
               <div class='f3'>
               <a href='login.php?id=$ab' class=b3 name=submit onclick=display()>Submit</a>
                </div>";
                ?>
            </form>
        </div>
